...
L'immagine si costruisce dal `Dockerfile` del repo. Il rilascio su
`ghcr.io/labinfinitek/remotek-api` arrivera' col tag `api-v0.1.0`: fino ad
allora l'immagine si costruisce in locale.
