...
| `test/contratto/` | golden delle risposte di v2.7 alle richieste del client 1.4.9 (per ora 8 passi: tre scenari anonimi che l'API implementa e i 404 delle cinque richieste che l'API non implementa, una delle quali nel gruppo `anonime`) e libreria Go di normalizzazione e confronto, stessa semantica del registratore | il contratto col client si verifica, non si ricorda | 0012, 0014, REGOLE 6.1 |
