...
| `resources/i18n/`, `global/i18n.go` (con i test) | messaggi dell'API in italiano, col tu e i termini del client RustDesk; i 22 ID usati nel codice che mancavano nei file di lingua; un file di lingua che non si carica ferma l'avvio | chi usa Remotek e' italiano: i messaggi erano in inglese o in cinese, dove mancava l'ID l'utente lo leggeva nudo, e un file rotto si saltava in silenzio | — |
