...
| `.github/workflows/remotek-ci.yml` (job `govulncheck`) | govulncheck v1.8.0 a versione fissata, bloccante: fallisce sulle vulnerabilita' note chiamate dal codice | una vulnerabilita' raggiunta ferma la MR, non si scopre dopo il rilascio | REGOLE 6.3, 8 |
