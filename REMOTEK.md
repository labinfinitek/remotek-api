...
| `resources/i18n/` (con i test) | messaggi dell'API in italiano, col tu e i termini del client RustDesk; i 22 ID usati nel codice che mancavano nei file di lingua | chi usa Remotek e' italiano: i messaggi erano in inglese o in cinese, e dove mancava l'ID l'utente lo leggeva nudo | — |
